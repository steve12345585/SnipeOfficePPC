...
# like the EXTNAME variable (used for confihiration processing)
# .INCLUDE :  $(PRJ)$/source$/<extension name>$/<extension_name>.pmk

# --- Files --------------------------------------------------------

# name for uniq directory
EXTENSIONNAME:=dict-hi
EXTENSION_ZIPNAME:=dict-hi
...
# just copy:
COMPONENT_FILES= \
    $(EXTENSIONDIR)$/hi_IN.aff \
    $(EXTENSIONDIR)$/hi_IN.dic \
...
CUSTOM_LICENSE=README_hi_IN.txt
