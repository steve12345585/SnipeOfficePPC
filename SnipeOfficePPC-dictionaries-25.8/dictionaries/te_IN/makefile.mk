...
EXTENSIONNAME:=dict-te
EXTENSION_ZIPNAME:=dict-te
...
# just copy:
COMPONENT_FILES= \
    $(EXTENSIONDIR)$/te_IN.aff \
    $(EXTENSIONDIR)$/te_IN.dic \
    $(EXTENSIONDIR)$/hyph_te_IN.dic \
    $(EXTENSIONDIR)$/README_hyph_te_IN.txt
...
CUSTOM_LICENSE=README_te_IN.txt
